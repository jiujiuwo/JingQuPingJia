...
tf.flags.DEFINE_string("train_data_path", "./data/train_first.csv", "Data source for the train data.")
tf.flags.DEFINE_integer("num_labels", 5, "Number of labels for data. (default: 2)")
...
# Load data
print("Loading data...")
x_text, y = new_data_helper.load_train_text_and_tag(FLAGS.train_data_path)
print(len(x_text))

# Get embedding vector
sentences, max_document_length = new_data_helper.padding_sentences(x_text, '.')
...
new_data_helper.saveDict(params, training_params_file)
...
with tf.Graph().as_default():
	...
	# Define Training procedure
        ...
        # Generate batches
        batches = new_data_helper.batch_iter(
